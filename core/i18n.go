...
const (
	...
	MsgManagedDeliveryInvalid     MsgKey = "managed_delivery_invalid"
	MsgManagedDeliveryUnavailable MsgKey = "managed_delivery_unavailable"
	MsgManagedDeliveryConflict    MsgKey = "managed_delivery_conflict"
...
var messages = map[MsgKey]map[Language]string{
	...
	MsgManagedDeliveryInvalid: {
		LangEnglish:            "Delivery requires POST with an exact session, request ID and non-command prompt.",
		LangChinese:            "请通过 POST 提供精确会话、请求 ID 和非命令消息。",
		LangTraditionalChinese: "請透過 POST 提供精確工作階段、請求 ID 和非命令訊息。",
		LangJapanese:           "POST でセッション、リクエスト ID、コマンド以外のメッセージを指定してください。",
		LangSpanish:            "Use POST con sesión exacta, ID de solicitud y un mensaje que no sea un comando.",
	},
	MsgManagedDeliveryUnavailable: {
		LangEnglish:            "Delivery storage or confirmation is unavailable; verify the original request before retrying.",
		LangChinese:            "投递存储或回执暂不可用，请先核验原请求。",
		LangTraditionalChinese: "投遞儲存或回執暫不可用，請先核驗原請求。",
		LangJapanese:           "配信の保存または確認が利用できません。元のリクエストを確認してください。",
		LangSpanish:            "El almacenamiento o la confirmación no está disponible; verifique la solicitud original.",
	},
	MsgManagedDeliveryConflict: {
		LangEnglish:            "Request identity conflicts or the project lacks a persistent single-workspace session.",
		LangChinese:            "请求身份冲突，或项目未使用可持久化的单工作区会话。",
		LangTraditionalChinese: "請求身分衝突，或專案未使用可持久化的單工作區工作階段。",
		LangJapanese:           "リクエストが競合するか、永続化された単一ワークスペースがありません。",
		LangSpanish:            "La identidad entra en conflicto o falta una sesión persistente de un solo espacio.",
	},
